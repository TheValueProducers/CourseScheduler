...
cmor_ba_supply_chain_requirement: List[Dict[str, Any]] = [{'id': 'or_intro_programming',
 ...
 {'id': 'or_advanced_requirement',
  'is_subrequirement': False,
  'requirement_type': 'choose_n',
  'courses': ['CMOR 404', 'CMOR 442', 'CMOR 444', 'CMOR 451'],
  'min_count': 1,
  'max_count': 1},
 {'id': 'or_senior_design',
  'is_subrequirement': False,
  'requirement_type': 'choose_group',
  'options': [['DSCI 435'], ['COMP 449'], ['CMOR 492', 'CMOR 493']],
  'min_count': 1,
  'max_count': 1},
